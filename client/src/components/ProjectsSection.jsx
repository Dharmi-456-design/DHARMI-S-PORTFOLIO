import { ArrowRight, ExternalLink, Github, ChevronUp, Star, Code, ChevronDown, MoveRight, Filter, Sparkles, Award, Zap, Play, Eye, Calendar, Users, X, FileText } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            A collection of projects I&apos;ve built across various domains, from interactive games to complex full-stack applications.
          </motion.p>
        </motion.div>
        ...
        {filteredProjects.length > 3 && (
          ...
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-medium transition-all duration-300 bg-primary text-primary-foreground hover:bg-primary/90`}
            >
              View More Projects
              <ArrowRight size={18} />
            </motion.button>
